const expectedStringsInEnvironmentVariables = ['orgLoginUrl','apiVersion','orgAdminUsername','orgAdminPassword','orgAdminSecurityToken'];
const expectedStringsInCollectionVariables = [];
