const expectedStringsInEnvironmentVariables = ['orgHostMySalesforceFormat','apiVersion','productNamesCommaDelimited'];
...
pm.collectionVariables.set('_cartStateOrId', 'active');
